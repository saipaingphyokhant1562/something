...
if(isset($_POST['submit']))
{
    ...
    {
        $status=$customer_controller->addNewCustomer($name,$firstname,$lastname,$phonenumber,$address1,$address2,$city,$state,$postcode,$country,$report_to,$credit);
         if($status)
         {
                        ...
                        <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" name="name" id="" value="<?php if(isset($name)) echo $name; ?>" class="form-control <?php if(isset($errormessage)) echo 'border border-danger'; ?>">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" name="firstname" id="" value="<?php if(isset($firstname)) echo $firstname; ?>" class="form-control <?php if(isset($firstname_error)) echo 'border border-danger'; ?>">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" name="lastname" id="" value="<?php if(isset($lastname)) echo $lastname; ?>" class="form-control <?php if(isset($lastname_error)) echo 'border border-danger'; ?>">
                                        <span class="text-danger"><?php if(isset($lastname_error)) echo $lastname_error; ?></span>
                                    </div>
                                    <div class="col-md-3">
                                        <label for="" class="form-label">Mobile Phone</label>
                                        <input type="tel" name="phonenumber" id="" value="<?php if(isset($phonenumber)) echo $phonenumber; ?>" class="form-control <?php if(isset($phonenumber_error)) echo 'border border-danger'; ?>">
                        ...
                        <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-md-2">
                                        ...
                                        <input type="text" name="address1" id="" value="<?php if(isset($address1)) echo $address1; ?>" class="form-control <?php if(isset($address1_error)) echo 'border border-danger'; ?>">
                        ...
                        <div class="col-md-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" name="credit" id="" class="form-control <?php if(isset($credit_error)) echo 'border border-danger'; ?>">
